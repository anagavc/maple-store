...
const OrderHistory = () => {
  ...
  return (
    <div className="w-full bg-pry-50 items-center justify-center flex-col flex h-full py-24 px-4">
      ...
      <>
        {order?.length === 0 ? (
          ...
          <>
            <div className="flex w-full lg:w-4/5 justify-center bg-gold items-center border px-4 lg:px-2 py-2 border-pry-100">
            ...
            {order?.map((order) => (
              <div
                ...
                className="flex w-full lg:w-4/5 py-2 justify-center  even:bg-gold items-center text-pry-100 text-base hover:cursor-pointer border-b border-x border-x-pry-100 border-b-pry-100 hover:bg-pry-100 hover:text-gold transition duration-300"
              >
