...
const NotFound = () => {
  return (
    <div className="flex  py-12 md:px-36 justify-center items-center bg-pry-50  -z-10  w-full">
      <FadeUpAnimation className="flex flex-col bg-pry-100 mt-3 md:mt-6 -z-5 space-y-6 border border-gold drop-shadow p-12 md:p-24 h-2/5 justify-center w-4/5 md:w-3/4 items-center">
