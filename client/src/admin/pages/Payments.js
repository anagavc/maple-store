    ...
    <div className="flex flex-col w-full mx-auto justify-between space-y-4">
      ...
      <div className="flex items-center justify-between space-x-4">
        ...
        <div className="flex space-x-2 justify-between">
          <NavigationButton path="addPayment">Add</NavigationButton>
          <NavigationButton path="entries">Entries</NavigationButton>
          <NavigationButton path="tellers">Tellers</NavigationButton>
          <button className="outline-none border-0 font-semibold text-sm transition duration-300 text-grey-500 hover:text-blue-500">
            Export
          </button>
      ...
      <div className="flex justify-between">
        <div className="flex justify-between w-3/5  space-x-8">
          {payments ? (
            <PrimaryButton path="addPayment">Add payment</PrimaryButton>
          ) : (
